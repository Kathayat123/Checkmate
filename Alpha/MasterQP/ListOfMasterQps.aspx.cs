    ...
    private void BindList()
    {
        ...
        if (ds != null && ds.Tables.Count > 0)
        {
            foreach (DataRow dr in ds.Tables[0].Rows)
            {
                ...
                if (ExamDate == "2019-07-08" && Shift == "1")
                {
                    tr0801.Visible = true;
                    html.Append("<a class='btn btn-4 swing' target='_blank' href='" + SavePath + "'>" + Subject + "</a>");
                    html.Append("<br/>");
                    ph08072019Shift1.Controls.Add(new LiteralControl(html.ToString()));
                    html.Clear();
                }
                if (ExamDate == "2019-07-08" && Shift == "2")
                {
                    tr0802.Visible = true;
                    html.Append("<a class='btn btn-4 swing' target='_blank' href='" + SavePath + "'>" + Subject + "</a>");
                    html.Append("<br/>");
                    ph08072019Shift2.Controls.Add(new LiteralControl(html.ToString()));
                    html.Clear();
                }
                if (ExamDate == "2019-07-08" && Shift == "3")
                {
                    tr0803.Visible = true;
                    html.Append("<a class='btn btn-4 swing' target='_blank' href='" + SavePath + "'>" + Subject + "</a>");
                    html.Append("<br/>");
                    ph08072019Shift3.Controls.Add(new LiteralControl(html.ToString()));
                    html.Clear();
                }
            }
        }
