...
<div id="wrapper">
  ...
  <div id="booking">
    <h2 style="height:33px; "><br />
        <font style="color:White;font-weight:bold; font-family:Arial; font-size:15px; text-transform:capitalize;">DUET Login </font></h2>
  ...
  <!-- end main -->
  <div id="footer"> &copy; Copyright DUET Booking Window</div>
  <!-- end footer -->
</div>
<!-- end wrapper -->
</body>
