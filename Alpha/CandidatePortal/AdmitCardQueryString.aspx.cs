...
public partial class CandidatePortal_AdmitCardQueryString :ClsErrorLog
{
        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    lblscribe.Text = Convert.ToString(ds.Tables[0].Rows[0]["WritingAssistanceRequired"]).ToUpper();
                    lblsub.Text = Convert.ToString(ds.Tables[0].Rows[0]["ExamPaper"]).ToUpper();
                    ...
                    lblApplNo.Text = Convert.ToString(ds.Tables[0].Rows[0]["Formno"]).ToUpper();
                    ...
                    imgPhoto.ImageUrl = Convert.ToString(ds.Tables[0].Rows[0]["UploadedPhotoFile"]);
                    imgSign.ImageUrl = Convert.ToString(ds.Tables[0].Rows[0]["SignatureFile"]);
                }
            }
            catch (Exception ex)
            {
