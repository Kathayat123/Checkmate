        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    imgPhoto.ImageUrl = "http://ntaexam.cbtexam.in/photo/" + lblAppName.Text + "/photo/" + Convert.ToString(ds.Tables[0].Rows[0]["UploadedPhotoFile"]).ToUpper();
                    imgSign.ImageUrl = "http://ntaexam.cbtexam.in/photo/" + lblAppName.Text + "/signature/" + Convert.ToString(ds.Tables[0].Rows[0]["SignatureFile"]).ToUpper();
                }
            }
            catch (Exception ex)
            {
