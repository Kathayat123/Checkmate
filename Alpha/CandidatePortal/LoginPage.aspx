            ...
            <div class="container" style="background-color: #A3BCDE;">
               ...
               <br /><br />
                ...
                <div class="main">
                    ...
                    <input type="text" class="form-control" placeholder="FORM NO" runat="server" id="txtLogin" maxlength="50" />
                    <input type="password" class="form-control" placeholder="DATE OF BIRTH (YYYYMMDD)" runat="server" id="txtPassword" maxlength="15" />
                    <br />
                    <span style="color:darkblue;">
                    *If your Date of birth is <strong>16 June 2001</strong> then your Password will be <strong>20010616</strong>  (YYYYMMDD)
                        </span>
                    <br />
