 ...
 * 		calendar.set("date");
 * </script> month_names: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
 */
calendar = {
    ...
    makeCalendar: function (year, month, day) {
        ...
        for (var i = current_year - 80; i < current_year + 10; i++) {
            this.wrt("<option value='" + i + "'")
        ...
        this.wrt("<tr class='header' style='height:20px;'>");
        ...
        this.wrt("</table>");
        this.wrt("<input type='button' value='Clear' class='calendar-cancel' onclick='calendar.hideCalendar();' />");
    ...
    showCalendar: function () {
        ...
        div.style.left = (xy[0] + 0 ) + "px";
        div.style.top = (xy[1]) - 195+  "px";
